...
using Core_NewSolutions.Services;
...
namespace Core_NewSolutions.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IAuthService authService, NewSolutionsContext db, UserManager<ApplicationUser> userManager)
        {
        ...
        //[Authorize(Roles = "SuperAdmin")]
        //[HttpGet("getAllUsers")]
        //public async Task<IActionResult> getAllUsers([FromQuery] PagingParameter_VM pagingparametermodel)
        //{
        //    var UsersInRoles = await (from user in db.Users
        ...
        //    int count = UsersInRoles.Count();
        //    int CurrentPage = pagingparametermodel.pageNumber;
        //    int PageSize = pagingparametermodel.pageSize;
        //    int TotalCount = count;
        //    int TotalPages = (int)Math.Ceiling(count / (double)PageSize);
        //    var items = UsersInRoles.Skip((CurrentPage - 1) * PageSize).Take(PageSize).ToList();
